...
export const ui = {
  pl: {
    ...
    'nt.notForProfile': 'Ta strona nie jest typowo opisywana dla wybranego profilu — pokazujemy ją, bo otworzyłeś ją bezpośrednio.',
    'nt.viaMechanism': 'przez mechanizm',
    ...
    'evExplain.A': 'A — najmocniejszy dowód: metaanalizy lub RCT potwierdzają działanie (a przy narzędziach diagnostycznych — mocna walidacja trafności).',
    ...
    'footer.sitemap': 'Mapa bazy',
    'footer.allTopics': 'Wszystkie tematy',
    'footer.about': 'O bazie',
    'footer.aboutText':
      'Nawigowalna baza sposobów na życie z ADHD, autyzmem lub oboma (AuDHD): od objawu przez mechanizm do konkretnej metody — z oceną dowodów i linkami do źródeł.',
    'footer.disclaimer':
      'To nie jest porada medyczna. Baza tworzona przez społeczność osób z ADHD/autyzmem — zawsze konsultuj się ze specjalistą.',
    'search.label': 'Szukaj',
    'search.placeholder': 'Szukaj w bazie — objawy, mechanizmy, metody…',
    'search.zeroResults': 'Brak wyników dla',
    'search.hint': 'Wpisz, żeby przeszukać całą bazę',
    'resource.video': 'Film',
  ...
  en: {
    ...
    'nt.notForProfile': "This page isn't typically flagged for the selected profile — shown because you opened it directly.",
    'nt.viaMechanism': 'via mechanism',
    ...
    'evExplain.A': 'A — strongest evidence: meta-analyses or RCTs directly confirm it works (or, for diagnostic tools, strong validation of accuracy).',
    ...
    'footer.about': 'About',
    'footer.aboutText':
      'A navigable base of ways to live with ADHD, autism or both (AuDHD): from a symptom through the mechanism to a concrete method — with an evidence grade and links to sources.',
    'footer.disclaimer':
      'This is not medical advice. Built by a community of people with ADHD/autism — always consult a professional.',
    'search.label': 'Search',
    'search.placeholder': 'Search the base — symptoms, mechanisms, methods…',
    'search.zeroResults': 'No results for',
    'search.hint': 'Type to search the whole base',
