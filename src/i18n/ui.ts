...
export const ui = {
  pl: {
    ...
    'nt.notForProfile': 'Ten sposób nie jest typowo opisywany dla wybranego profilu — pokazujemy go, bo otworzyłeś go bezpośrednio.',
  ...
  en: {
    ...
    'nt.notForProfile': "This method isn't typically flagged for the selected profile — shown because you opened it directly.",
