  ...
  "addresses": [
    {
      ...
      "evidence": "C",
      "community": "średni",
      "note": "Kolorowanie kalendarza daje wizualny obraz całego dnia, którego mózg ze ślepotą czasu nie wytwarza sam."
    },
    {
      "target": "slepota-czasu",
      "kind": "mechanism",
      "evidence": "C",
      "community": "średni",
      "note": "Eksternalizuje percepcję czasu — robi widzialnym to, czego mózg nie czuje intuicyjnie."
    }
  ],
  "resources": [
    {
      "title": "I Spent Years Pretending I Was Fine (uczyń czas widzialnym)",
      "type": "video",
  ...
  "studies": [
    {
      ...
      "year": 2014,
      "finding": "Mały RCT (n=37, wiek 6-11, ADHD oraz ASD/niepełnosprawność intelektualna/rozszczep kręgosłupa/MPD) interwencji z pomocami czasowymi, które uzewnętrzniają i uwidaczniają czas. Grupa interwencyjna poprawiła zdolność przetwarzania czasu (d=0,81, duży efekt) i zarządzania czasem (d=0,68, średni efekt) istotnie bardziej niż grupa z listy oczekujących. Autorzy nazywają to 'wstępnym dowodem'. Mieszana populacja i mała próba ograniczają wnioski swoiste dla ADHD."
    },
    {
      ...
      "year": 2022,
      "finding": "Przegląd systematyczny wizualnych planów aktywności (wizualnej reprezentacji dnia) u dzieci z ADHD. Tylko 4 badania spełniły kryteria; włączony RCT oceniono jako niskiej jakości. Interwencje wiązały się z redukcją problemowych zachowań i większą satysfakcją, ale baza dowodowa jest cienka i nie ukierunkowana swoiście na percepcję czasu."
    },
    {
      ...
      "year": 2023,
      "finding": "Przegląd narracyjny potwierdza, że zaburzenie percepcji czasu / ślepota czasowa to spójna cecha ADHD (silny mechanizm). Wprost zaznacza, że podręczniki leczenia dorosłego ADHD nie uwzględniają deficytu percepcji czasu, a dowodów interwencyjnych jest minimalnie — praktycznie brak kontrolowanej oceny zewnętrznych/wizualnych pomocy czasowych czy kolorowania kalendarza."
    }
  ]
}
---

Przy ślepocie czasu mózg nie postrzega upływu czasu intuicyjnie, więc zarządzanie nim trzeba przenieść na zewnątrz, robiąc czas WIDZIALNYM. Najprostsza dźwignia: kolory w kalendarzu. Każdy typ wydarzenia ma swój kolor, dzięki czemu rzut oka na dzień od razu mówi, co i kiedy — a brak/zły kolor potrafi realnie kosztować pół godziny spóźnienia (autorka podaje to z własnego dnia). Dokładaj inne zewnętrzne markery (alarmy, widoczne zegary, tablica), żeby żaden termin nie był „niewidzialny”. To różni się od alarmów-jako-czasu: tu chodzi o WIZUALNĄ reprezentację całego dnia naraz, nie o pojedyncze pingi.
