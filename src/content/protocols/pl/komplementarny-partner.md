---
{
  "title": "Dobierz komplementarnego partnera (yin do twojego yang)",
  "summary": "Łącz się z kimś o przeciwnych mocnych stronach — bardziej asertywnym lub spokojnym, kto hamuje, gdy ty startujesz bez opamiętania — w związku, biznesie czy zespole.",
  "icon": "mdi:tools",
  "order": 37,
  "conditions": [
    "adhd",
  ...
  "addresses": [
    {
      ...
      "evidence": "C",
      "community": "niski",
      "note": "Komplementarny partner równoważy impulsywne starty follow-through i logiką."
    }
  ],
  "resources": [
    {
      "title": "Jordan Stephens o ADHD: yin do twojego yang",
      "type": "video",
