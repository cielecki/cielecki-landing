---
{
  "title": "Audyt energii: must-vs-want, parking, nowa gra",
  "summary": "Pytaj, czy CIAŁO udźwignie to, na co zapisała się GŁOWA. Zostaw „parking” na to, czego świadomie nie zrobisz, i zaczynaj każdy dzień od zera.",
  ...
  "addresses": [
    {
      ...
      "evidence": "C",
      "community": "niski",
      "note": "Parking + must-vs-want + „jutro nowa gra” chronią energię i tną poczucie winy."
    }
  ],
  "resources": [
    {
      "title": "Magdalena Daniłoś: parking, must-vs-want, „jutro nowa gra”",
