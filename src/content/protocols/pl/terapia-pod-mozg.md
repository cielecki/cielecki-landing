---
{
  "title": "Dobierz terapię do mózgu",
  "summary": "„Terapia nie zadziałała” często znaczy „ta modalność nie pasowała”. Trzecia fala CBT (DBT, ACT) i Gestalt bywają trafniejsze dla mózgu ADHD niż np. psychodynamiczna.",
  ...
  "addresses": [
    {
      ...
      "evidence": "B",
      "community": "średni",
      "note": "Trzecia fala CBT (DBT/ACT) i Gestalt bywają trafniejsze dla ADHD niż psychodynamiczna."
    }
  ],
  "resources": [
    {
      "title": "Magdalena Daniłoś: która terapia pasuje do mózgu ADHD",
