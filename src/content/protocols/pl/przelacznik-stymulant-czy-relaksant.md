---
{
  "title": "Pytanie-przełącznik: stymulant czy relaksant?",
  "summary": "Zanim sięgniesz po porno, zapytaj: pełni dla mnie rolę stymulanta czy relaksanta? Zdiagnozowanie potrzeby pozwala podstawić lepsze rozwiązanie pełniące tę samą funkcję — i zbudować plan „jeśli trigger, to…”.",
  "icon": "mdi:tools",
  "order": 73,
  "conditions": [
    "adhd",
  ...
  "addresses": [
    {
      ...
      "evidence": "C",
      "community": "niski",
      "note": "Diagnozuje funkcję porno i podstawia alternatywę pełniącą tę samą rolę."
    },
    {
      ...
      "evidence": "C",
      "community": "niski",
      "note": "Przesuwa fokus z „jestem zepsuty” na „jaką potrzebę to zaspokaja”."
    },
    {
      "target": "porno-coping-emocjonalny",
      "kind": "mechanism",
      "evidence": "C",
      "community": "niski",
      "note": "Wprost adresuje coping-funkcję porno, nazywając ją i zastępując."
    }
  ],
  "resources": [
    {
      "title": "Dlaczego mózg ADHD pragnie porno — pytanie: stymulant czy relaksant?",
      "type": "video",
      "url": "https://www.youtube.com/watch?v=4WLrWby82dY&t=446s",
      "note": "„Czy porno jest stymulantem czy relaksantem? Gdy rozumiesz jego rolę, znajdziesz lepsze rozwiązanie.”"
    },
    {
      "title": "Dlaczego mózg ADHD pragnie porno — tygodniowy eksperyment + plan",
      "type": "video",
      "url": "https://www.youtube.com/watch?v=4WLrWby82dY&t=609s",
      "note": "„Przez tydzień przy każdej ochocie pytaj: czego potrzebuję? Potem zbuduj prewencyjny plan.”"
    },
    {
      "title": "Dlaczego mózg ADHD pragnie porno — superior way do pobudzenia",
      "type": "video",
      "url": "https://www.youtube.com/watch?v=4WLrWby82dY&t=472s",
...
Porno to najczęściej samoleczenie, więc kluczowe jest pytanie (za dr Tamarą Rosier): czego ono dla mnie używa — pobudza czy wycisza? (1) Jeśli to stymulant — kick z „flatline” — następnym razem zapytaj: jak inaczej mogę się pobudzić? (spacer, telefon do znajomego, wciągająca książka). (2) Jeśli to relaksant — gdy jesteś „wired but tired”, a porno daje punkt skupienia i ukojenie — zapytaj: jak inaczej się zrelaksować? (medytacja, spacer, znajomy, który cię wycisza). Uwaga: ta sama aktywność potrafi działać różnie zależnie od kontekstu (jeden znajomy uspokaja, inny nakręca) — dobieraj świadomie pod potrzebę. Praktyka: przez tydzień przy każdej ochocie pytaj „czego potrzebuję — stymulanta czy relaksanta i jakie lepsze rozwiązanie?”. Po tygodniu znasz dominującą rolę porno i listę działających alternatyw — z tego zbuduj prewencyjny plan „jeśli trigger, to…”, żeby reakcja była automatyczna.
