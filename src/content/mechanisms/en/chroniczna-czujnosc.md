---
{
  "title": "Chronic hypervigilance (learned dread)",
  "summary": "A constant low-level nervous-system alert state in which the ADHD brain won't let itself relax because past experience taught it that relaxing led to things going wrong — blocking the wind-down needed for sleep.",
...
The key insight: dread fades not when problems stop but when the brain decides it can handle things going wrong. Building a sense of safety and capability (rather than eliminating every threat) is what lets the nervous system stand down and allow sleep.
