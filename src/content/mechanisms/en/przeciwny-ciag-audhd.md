---
{
  "title": "ADHD ↔ autism opposing pull",
  "summary": "In someone with both ADHD and autism the two profiles can pull in opposite directions: ADHD drives impulsive action (novelty, dopamine from the thought), and the autism rejects it moments after starting (effort, stimuli, overwhelm) — hence a 'start-then-abort' cycle.",
